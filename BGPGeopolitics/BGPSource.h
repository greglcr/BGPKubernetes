...
public:
    ...
    BGPSource(BGPMessagePool *bgpMessagePool, unsigned int t_start, unsigned int t_end, unsigned int dumpDuration, std::map<std::string, unsigned short int> &collectors, std::string &captype, int version, std::string pathCache);
    int run();
